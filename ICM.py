...
st.markdown(f'### <html><body><h1 style="font-family:Neutro; font-size:40px"> Industrial Copper Modelling</h1></body></html>', unsafe_allow_html=True)
...
with tab2:
    ...
    try:
        ...
        if status == 1:
            ...
            # apply custom css style for prediction text
            #style_prediction()
            hide_streamlit_style = """ <html><body><h1 style="font-family:Neutro; font-size:40px"> Predicted Status=Won </h1></body></html>"""
            ...
            # apply custom css style for prediction text
            #style_prediction()'
            hide_streamlit_style = """ <html><body><h1 style="font-family:Neutro; font-size:40px"> Predicted Status=Loss </h1></body></html>"""
            st.markdown(hide_streamlit_style, unsafe_allow_html=True)
            st.snow()
...
<b>Project_Title</b>: <br>Industrial Copper Modeling <br>
<b>Technologies_Used</b> :<br> Python scripting, Data Preprocessing,EDA, Streamlit
<br>
<b>Dataset: </b>https://docs.google.com/spreadsheets/d/18eR6DBe5TMWU9FnIewaGtsepDbV4BOyr/edit?usp=sharing&ouid=104970222914596366601&rtpof=true&sd=true <br>
<b>Domain </b> : Manufacturing<br>
<b>Problem Statement:</b>: <br>
Exploring skewness and outliers in the dataset.<br>
1.Transform the data into a suitable format and perform any necessary cleaning and pre-processing steps.<br>
2.ML Regression model which predicts continuous variable ‘Selling_Price’.<br>
3.ML Classification model which predicts Status: WON or LOST.<br>
4.Creating a streamlit page where you can insert each column value and you will get the Selling_Price predicted value or Status(Won/Lost)<br>
